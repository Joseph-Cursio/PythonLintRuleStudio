...
class TestConfigGeneration(unittest.TestCase):
    def setUp(self):
        ...
        self.app.managed_prefixes = {"F", "E", "C"}
        self.app.managed_rules = {"F401", "E501", "C0103"}

    def test_select_category(self):
        self.app.staged_changes = {"F": "select"}
        ruff_config, _ = self.app.get_effective_configs()
    ...
    def test_pylint_disable_rule(self):
        self.app.staged_changes = {"C0103": "ignore"}
        _, pylint_config = self.app.get_effective_configs()
